    ...
    <div className="page-container">
      ...
      <section className="hero-section position-relative overflow-hidden bg-white">
        <div className="position-absolute w-100 h-100" style={{
          background: 'radial-gradient(circle at 30% 50%, rgba(66, 10, 10, 0.83) 0%, rgba(29, 4, 6, 0.8) 90%)',
          zIndex: 1
        }}></div>
        <div className="position-absolute w-100 h-100" style={{
          backgroundImage: 'url("https://digpu.com/wp-content/uploads/2020/07/GL-Bajaj-Digpu.jpg")',
          ...
          <div className="row min-vh-100 align-items-center py-5">
            <div className="col-lg-7 animate-fade-in">
              ...
              <h1 className="display-3 fw-bold text-white mb-4">
                Smart Campus <span className="text-gradient e-inline-block">Transportation</span>
              </h1>
              ...
              <div className="d-flex flex-wrap gap-3 mt-5">
                <Link to="/routes" className="btn btn-primary btn-lg px-4 py-3 shadow-lg bg-red">
          ...
          <div className="row g-5 align-items-center py-4">
            <div className="col-lg-6 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="position-relative p-3">
                <img 
                  src="https://smartcampus.unsw.edu.au/index_files/header_img.png" 
      ...
      <section className="cta-section py-5 text-center text-white position-relative overflow-hidden" style={{ 
        ...
        <div className="position-absolute" style={{ right: '5%', top: '20%', width: '150px', height: '150px', 
                                                 background: 'rgba(180, 35, 35, 0.36)', borderRadius: '50%' }}></div>
        <div className="position-absolute" style={{ left: '10%', bottom: '10%', width: '200px', height: '200px', 
                                                  background: 'rgba(213, 71, 71, 0.15)', borderRadius: '50%' }}></div>
        ...
        <div className="container position-relative py-5" style={{ zIndex: '2' }}>
          <div className="row justify-content-center py-3">
            <div className="col-lg-8 col-md-10 animate-fade-in">
              ...
              <p className="lead mb-5 text-black">Experience the future of campus transportation with our intelligent shuttle management system.</p>
              <div className="d-flex justify-content-center gap-3 flex-wrap">
                <Link to="/register" className="btn btn-light btn-lg px-5 py-3 shadow">
                  <i className="bi bi-person-plus me-2"></i>
                  Create Account
                </Link>
                <Link to="/routes" className="btn btn-outline-light btn-lg px-5 py-3 text-black">
                  <i className="bi bi-map me-2"></i>
                  View Routes
                </Link>
              </div>
